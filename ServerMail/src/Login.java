...
public class Login {
    ...
    public void loginInfo(Scanner sc, PrintStream out) throws SQLException, SignUpException {
        String usrName, pass;
    ...
    public void checkUser(String usrName, String pass, Scanner sc, PrintStream out) throws SQLException, SignUpException {
